let myjokes = [ 
  ...
  //you can add more jokes with free jokes api on google.
  
  ]
  
  let joke_teller = Math.floor(Math.random() * (myjokes.length - 1))
  console.log(joke_teller)
  joke.innerHTML = myjokes[joke_teller].joke